...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "WeexScanQR/ios/Sources/SGQRCode/SGQRCode.bundle"
  install_resource "WeexScanQR/ios/Sources/SGQRCode/SGQRCode.bundle/en.lproj/Root.strings"
  install_resource "WeexScanQR/ios/Sources/SGQRCode/SGQRCode.bundle/QRCodeScanningLine@2x.png"
  install_resource "WeexScanQR/ios/Sources/SGQRCode/SGQRCode.bundle/QRCodeScanningLine@3x.png"
  install_resource "WeexScanQR/ios/Sources/SGQRCode/SGQRCode.bundle/QRCodeScanningLineGrid@2x.png"
  install_resource "WeexScanQR/ios/Sources/SGQRCode/SGQRCode.bundle/QRCodeScanningLineGrid@3x.png"
  install_resource "WeexScanQR/ios/Sources/SGQRCode/SGQRCode.bundle/Root.plist"
  install_resource "WeexScanQR/ios/Sources/SGQRCode/SGQRCode.bundle/sound.caf"
